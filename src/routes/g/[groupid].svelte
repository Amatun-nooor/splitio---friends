...
<SvelteSeo
	openGraph={{
		...
		url: 'https://github.com/Amatun-nooor/splitio-with-friends',
		type: 'website',
		images: [
			{
				url: 'https://raw.githubusercontent.com/Amatun-nooor/splitio-with-friends/main/static/splitio_banner.png',
				width: 1280,
				height: 640,
